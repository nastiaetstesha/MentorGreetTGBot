...
from utils import load_json, start, show_mentors, select_mentor, select_card
from utils2 import show_mentors2
...
if __name__ == "__main__":
    ...
    dp.add_handler(MessageHandler(Filters.text("📜 Список менторов"), show_mentors2))
